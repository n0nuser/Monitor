    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "token",
                    models.CharField(
                        default=web.models.Agent.token,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "agent",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="web.agent"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "logging_filename",
                    models.CharField(default="monitor.log", max_length=100),
                ),
                (
                    "logging_level",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(default="metrics.json", max_length=100),
                ),
                (
                    "metrics_post_interval",
